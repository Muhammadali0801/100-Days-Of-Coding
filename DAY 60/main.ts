...
function showMessage() {
    let message = "Hello i am typescript"; // local variable
    console.log(message);
...
/*We can pass arbitrary data to functions using parameters.In the example below,
 ...
 function showDiffMessage(from, text) { // parameters: from, text
  ...
  /*You can assign default values to parameters. If the parameter is not provided,
   ...
   function greet12(name: string, greeting: string = "Hello"){
...
let sum: number = add(2, 3); // sum is 5
