...
var jsonStrings = '{"name":"Alice","age":30,"city":"wonderland"}';
// Parses the JSON string back into a JavaScript object
var persons = JSON.parse(jsonStrings);
...
var jsonString1 = JSON.stringify(person, null, 2); // The '2' specifies the number of spaces to use as white space
