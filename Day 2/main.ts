   ...
   console.log('Steve Jobs Once Said,"Your time is limited, so dont waste it living someone elses life. Dont be trapped by dogma - which is living with the results of other peoples thinking"');
    ...
    let famouse_person: string ="Steve Jobs";
    let message: String = `${famouse_person} Once Said,"Your time is limited, so dont waste it living someone elses life. Dont be trapped by dogma - which is living with the results of other peoples thinking."`;
